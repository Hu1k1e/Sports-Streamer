...
5. Crucially, set the **Environment Variables**:
   - `PROXY_HOST`: Set this to `http://<YOUR_DOCKER_HOST_IP>:5000` (e.g., `http://192.168.1.50:5000`). If left as `127.0.0.1`, Jellyfin will not be able to connect.
...
4. In the **File or URL** field, enter the URL of your local proxy's playlist endpoint:
   `http://<YOUR_DOCKER_HOST_IP>:5000/playlist.m3u`
